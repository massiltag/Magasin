...
public class GPersoUI extends JFrame implements ActionListener {		// Interface gérant personnel
	...
	public static DefaultTableModel updateTable(ArrayList<Employe> employes){
		String [] headers = {"ID","Nom","Rôle","Adresse","Login","Salaire Horaire","Nb. Heures/sem","Salaire","RIB","Infos comp."};
		...
		for (Employe e : employes) {
			...
			switch(type) {
				...
				case "personnel.GerantStock":
					data[9] = "Dépôts " + ((GerantStock)e).getArray().toString();
					break;
