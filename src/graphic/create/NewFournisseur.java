...
import acteurs.Fournisseur;
import graphic.*;

@SuppressWarnings({ "unused", "serial" })
public class NewFournisseur extends JFrame implements ActionListener {
	...
	public NewFournisseur() {
		this.setTitle("Nouveau Fournisseur");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==ok) {
			if (this.check()) {
				Fournisseur c = new Fournisseur(nom.getText(),adr.getText());
				GStockUI.updateFournisseurs();
				this.close();
			}
		}
